...
namespace VRStandardAssets.Utils
{
    ...
    */
    public class VREyeRaycaster : MonoBehaviour
    {
        ...
        // shoot the eye raycase every frame
        private void Update()
        {
            EyeRaycast();
        }
        ...
        // Method to deactive the last interactive item 
        ...
        // when the VR is active and the user looks up
        ...
        // when the VR is active and the user looks down
        ...
        // handle the clicking from the controller or the mouse
